...
check_that_these_are_equal(is_first_of_the_month(1), "First of the month!")

check_that_these_are_equal(is_first_of_the_month(12), "Not first of the month")
...
check_that_these_are_equal(has_five_chars("ABCDE"), "ABCDE is five characters long")

check_that_these_are_equal(has_five_chars("FORGE"), "FORGE is five characters long")

check_that_these_are_equal(has_five_chars("Nope"), "Not five characters")

check_that_these_are_equal(has_five_chars("Nor this one"), "Not five characters")

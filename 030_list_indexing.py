...
check_that_these_are_equal(get_first_item(["a", "b", "c", "d", "e"]), "a")

check_that_these_are_equal(get_first_item([34, 44, 54, 64]), 34)
...
check_that_these_are_equal(get_last_item(["a", "b", "c", "d", "e"]), "e")

check_that_these_are_equal(get_last_item([34, 44, 54, 64]), 64)
...
check_that_these_are_equal(get_nth_item(["a", "b", "c", "d", "e"], 3), "d")

check_that_these_are_equal(get_nth_item([34, 44, 54, 64], 1), 44)
...
check_that_these_are_equal(
    get_items_between_one_and_three(["a", "b", "c", "d", "e"]), ["b", "c"]
)

check_that_these_are_equal(get_items_between_one_and_three([34, 44, 54, 64]), [44, 54])

...
check_that_these_are_equal(append_item_to_list(["a", "b"], "c"), ["a", "b", "c"])
check_that_these_are_equal(append_item_to_list([3, 1], 6), [3, 1, 6])
...
check_that_these_are_equal(remove_item_from_list(["a", "b"], "b"), ["a"])
check_that_these_are_equal(remove_item_from_list([3, 1], 3), [1])
...
check_that_these_are_equal(count_items_in_list(["a", "b", "a"], "a"), 2)
check_that_these_are_equal(count_items_in_list([4, 1, 4, 4], 4), 3)
...
check_that_these_are_equal(get_index_of_item(["a", "b", "c"], "b"), 1)
check_that_these_are_equal(get_index_of_item([33, 44, 55], 55), 2)
...
check_that_these_are_equal(reverse_list(["a", "b", "c"]), ["c", "b", "a"])
check_that_these_are_equal(reverse_list([33, 44, 55]), [55, 44, 33])
...
check_that_these_are_equal(list_length(["a", "b", "c"]), 3)
check_that_these_are_equal(list_length([33, 44]), 2)
